  ...
  <el-container>
    <el-main>
      <el-form ref="form" :model="form" :rules="formRules" label-width="100px" style="width: 700px;">
        ...
        <el-row>
          <el-col :span="12" v-if="form.db_type != 'sqlite'">
            <el-form-item label="主机名" prop="db_host">
              <el-input v-model="form.db_host"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="form.db_type == 'sqlite'">
            <el-form-item label="数据文件名" prop="db_host">
              <el-input v-model="form.db_host" placeholder="default.db"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12" v-if="form.db_type != 'sqlite'">
...
export default {
  ...
  methods: {
    update_port (dbType) {
      ...
      if (dbType === 'sqlite') {
        this.form['db_port'] = 1
        this.form['db_host'] = 'default.db'
        this.form['db_username'] = 'default'
        this.form['db_password'] = 'default'
        this.form['db_name'] = 'default'
      } else {
